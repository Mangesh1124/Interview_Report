...
const RoadMapDay = ({ day }) => (
  <div className="roadmap-day">
    ...
    <p className="roadmap-day__task">{day.task}</p>
  </div>
);  
...
const Interview = () => {
  ...
  const { report, getReportById, loading, getResumePdf ,generateResumePdfForReport} = useInterview();
    ...
    <div className="interview-page">
      <div className="interview-layout">
        ...
        <nav className="interview-nav">
          ...
          <button
            onClick={() => {
              generateResumePdfForReport(interviewId);
            }}
